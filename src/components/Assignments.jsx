    ...
    <div className="terminal-window">
      ...
      <div className="terminal-body">
        ...
        <div className="shared-requirements">
          ...
          <div className="requirement-group">
            ...
            <ul className="terminal-list">
              ...
              <li>
                Mid-term survey: Feedback on learning progress and your feelings
                so far
              </li>
        ...
        <div className="path-options">
          ...
          <div className="path">
            <h4 className="path-title">Solo Player Path</h4>
            ...
            <div className="assignment">
              ...
              <div className="assignment-details">
                ...
                <ul className="terminal-list">
                  <li>
                    Document your gaming expeditions and generate questions
                  </li>
                  <li>
                    Connect gameplay experiences to course readings and
                    discussions
                  </li>
                  <li>
                    Include meaningful visual evidence (screenshots/footage)
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="path">
            <h4 className="path-title">Multiplayer Path</h4>

            <div className="assignment">
              <h5>Group Moodboarding</h5>
              <div className="assignment-details">
